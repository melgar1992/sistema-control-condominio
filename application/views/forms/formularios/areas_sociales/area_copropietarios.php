       ...
       <div class="">
           ...
           <div class="row">
               <div class="col-md-12 col-sm-12 col-xs-12">
                   <div class="x_panel">
                       <div class="x_title">
                           <h2>Control copropietarios areas sociales</h2>
                       ...
                       <div class="x_content">
                           ...
                           <form method="POST" action="<?php echo base_url(); ?>Formularios/Control_area_copropietarios/guardarControlArea" id="control" class="form-horizontal form-label-left">
                           ...
                           <div class="row">
                               <div class="col-md-12 col-sm-12 col-xs-12">
                                   <div class="x_panel">
                                       ...
                                       <div class="x_content">
                                           <table id="tabla_control" class="table table-bordered btn-hover">
                                               <thead>
                                                   <tr>
       ...
       <div class="modal-dialog">
           <div class="modal-content">
               ...
               <div class="modal-body ui-front">
                   <form method="POST" action="<?php echo base_url(); ?>Formularios/Control_area_copropietarios/actualizarReservaAreaSocial" id="form-editar" class="form-horizontal form-label-left">
